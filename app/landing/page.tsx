	...
	const features = [
		{
			...
			description:
				"Log your meals effortlessly with our extensive food database and custom meal builder.",
		},
		{
			icon: Target,
			title: "Personalized Goals",
			description:
				"Set and track custom calorie, macro, and activity goals tailored to your needs.",
		},
		{
			icon: TrendingUp,
			title: "Progress Analytics",
			description:
				"Visualize your journey with detailed charts and insights into your health trends.",
		},
		{
			icon: Activity,
			title: "Workout Logging",
			description:
				"Track your exercises and see how they contribute to your overall health goals.",
		},
		{
			icon: Users,
			title: "Community Support",
			description:
				"Connect with others on similar health journeys for motivation and tips.",
		},
		{
			icon: Award,
			title: "Achievements",
			description:
				"Celebrate milestones and stay motivated with our achievement system.",
		},
	];
				...
				<div className="grid lg:grid-cols-2 gap-12 items-center">
					<div className="space-y-6">
						...
						<p className="text-xl text-muted-foreground text-pretty">
							Track calories, log meals, monitor progress, and achieve your
							health goals with Archer Health - your all-in-one wellness
							companion.
						</p>
					...
					{[
						{
							...
							description:
								"Sign up and set your health goals, dietary preferences, and activity level.",
						},
						{
							step: "2",
							title: "Track Your Progress",
							description:
								"Log meals, workouts, and daily activities to monitor your journey.",
						},
						{
							step: "3",
							title: "Achieve Your Goals",
							description:
								"Use insights and analytics to stay on track and reach your targets.",
						},
					].map((item) => (
