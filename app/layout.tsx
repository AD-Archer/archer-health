...
const baseUrl = process.env.NEXT_PUBLIC_SITE_URL || "https://health.adarcher.app"

export const metadata: Metadata = {
  title: "Archer Health | Calorie & Health Tracker",
  description: "Track your calories, meals, workouts, and achieve your health goals with Archer Health.",
  ...
  openGraph: {
    ...
    images: [
      { url: "/banner.webp", width: 1200, height: 630, alt: "Archer Health Banner" },
